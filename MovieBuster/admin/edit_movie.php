                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Edit Movie</h5>
                                    <span>Edit Movie From here</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-block">
                                ...
                                $sql1 = "SELECT srno,movie_name,movie_lang,movie_time,seat_booked,theater_name,rating,audi_no FROM movie_details where srno=".$id;
                                $result1 = mysqli_query($conn, $sql1);
                                while($row1 = mysqli_fetch_assoc($result1)) {

                                ?>
                                <form id="main" method="post" action="edit_movie_page.php" novalidate>
                                  <div class="form-group row">
                                    <!-- <label class="col-sm-2 col-form-label">Sr No.</label> -->
                                    <div class="col-sm-10">
                                        <?php echo  "<input type='hidden' class='form-control' name='sr_no' id='sr_no' value='".$row1['srno']."'>"; ?>
                                      <!-- <input type="text" class="form-control" name="name" id="sr_no" placeholder="Enter Movie Name"> -->
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <!-- <input type="text" class="form-control" name="name" id="name" placeholder="Enter Movie Name"> -->
                                        ...
                                        <?php echo  "<input type='text' class='form-control' required name='name' id='sr_no' placeholder='Enter Movie Name' value='".$row1['movie_name']."'>"; ?>
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Seat Booked</label>
                                    <div class="col-sm-10">
                                      <!-- <input type="number" class="form-control" id="Number" name="Number" placeholder="Enter Day Number"> -->

                                        <?php echo  "<input type='text' class='form-control' required name='seat_booked' id='sr_no' placeholder='Enter Movie Name' value='".$row1['seat_booked']."'>"; ?>
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <!-- <input type="text" class="form-control" name="movie_language" id="name" placeholder="Enter Movie Language"> -->

                                        <?php echo  "<input type='text' class='form-control' required name='movie_language' id='sr_no' placeholder='Enter Movie Name' value='".$row1['movie_lang']."'>"; ?>
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php echo  "<input type='text' class='form-control' required name='movie_time' id='sr_no' placeholder='Enter Movie Name' value='".$row1['movie_time']."'>"; ?>
                                      <!-- <input type="text" class="form-control" name="movie_time" id="name" placeholder="Enter Movie Time"> -->
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php echo  "<input type='text' class='form-control' required name='theater_name' id='sr_no' placeholder='Enter Movie Name' value='".$row1['theater_name']."'>"; ?>
                                      <!-- <input type="text" class="form-control" name="theater_name" id="name" placeholder="Enter Theater Name"> -->
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php echo  "<input type='text' class='form-control' required name='audi_no' id='sr_no' placeholder='Enter Movie Name' value='".$row1['audi_no']."'>"; ?>
                                      <!-- <input type="number" class="form-control" name="audi_number" id="name" placeholder="Enter Audi Number"> -->
                                      <span class="messages" style="color: red"><?php if (isset($_SESSION['empty_fields'])) {
