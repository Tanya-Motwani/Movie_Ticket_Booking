                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Movie Data</h5>
                                            <span>Here You Can Manage Movies And It's Information</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">ManageMovies</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <a href="add_movie.php" style="color: white"><button type="button" id="addRow" class="btn btn-primary m-b-20 m-l-15"> + Add Movie</button></a> 
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover m-b-0">
                                                                <thead>
                                                                    <?php 
                                                                        $sql1 = "SELECT srno,movie_name,movie_lang,movie_time,seat_booked,theater_name,rating,audi_no FROM movie_details";
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                <div class="d-inline-block">
                                                                                    <h6><?php echo $row1['movie_name']; ?></h6>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td><?php echo $row1['movie_lang']; ?></td>
                                                                        <td><?php echo $row1['movie_time']; ?></td>
                                                                        <td><?php echo $row1['theater_name']; ?></td>
                                                                        <td>
                                                                        ...
                                                                        <td style="text-align: center;"><?php echo $row1['seat_booked']; ?></td>
                                                                        <td><?php echo $row1['audi_no']; ?></td>
                                                                        <td><a <?php echo "href='edit_movie.php?id=".$row1['srno']."'" ?>><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a><a <?php echo "href='delete_movie.php?id=".$row1['srno']."' onclick='return confirmDelete()'" ?>><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a></td>
                                                                    </tr>
                                                                <?php } ?>
                                                                </tbody>
                                                            </table>
