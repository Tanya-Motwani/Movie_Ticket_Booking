                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    <h5>Edit Users</h5>
                                    <span>Edit Users From here</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="card">
                              ...
                              <div class="card-block">
                                ...
                                $sql1 = "SELECT user_id,email_id,name,password FROM user_details where user_id=".$id;
                                $result1 = mysqli_query($conn, $sql1);
                                while($row1 = mysqli_fetch_assoc($result1)) {

                                ?>
                                <form id="main" method="post" action="edit_user_page.php" novalidate>
                                  <div class="col-sm-10">
                                        <?php echo  "<input type='hidden' class='form-control' name='user_id' id='sr_no' value='".$row1['user_id']."'>"; ?>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <!-- <input type="text" class="form-control" name="user_name" id="name" placeholder="Enter User Name"> -->
                                      <?php echo  "<input type='text' class='form-control' required name='name' id='user_name' value='".$row1['name']."'>"; ?>
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <?php echo  "<input type='email' class='form-control' required name='email_id' id='email' value='".$row1['email_id']."'>"; ?>
                                      <!-- <input type="email" class="form-control" id="Number" name="email_id" placeholder="Enter Email"> -->
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <?php echo  "<input type='text' class='form-control' required name='password' id='passoword' value='".$row1['password']."'>"; ?>
                                      <!-- <input type="text" class="form-control" name="password" id="name" placeholder="Enter Movie Language"> -->
                                      <span class="messages"><?php if (isset($_SESSION['empty_fields'])) {
