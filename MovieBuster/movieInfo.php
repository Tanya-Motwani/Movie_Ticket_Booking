  ...
  <head>
	...
	<style>
		...
		.bg-image-full {
			...
			/* The image used */
			background-image: url("movie_data/kalank.jpg");
  ...
  <body id="page-top">
    ...
    <section class="py-5 download bg-primary">
      <div class="container">
		...
		<p>Long-buried secrets come to light when romance blossoms between a young daredevil and a beautiful woman in 1945 India.Kalank a true labour of love that tells you a story laced with beautiful moments that will tug you at your heartstrings.</p>
      </div>
    </section>
